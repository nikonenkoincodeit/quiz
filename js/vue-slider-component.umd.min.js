  ...
  return (function (t) {
    ...
    fb15: function (t, e, r) {
      ...
      function d(t, e) {
        return (
          void 0 === e && (e = {}),
          Object(l["createDecorator"])(function (r, n) {
            ((r.props || (r.props = {}))[n] = e),
      ...
      function f(t) {
        return (
          void 0 === t && (t = {}),
          Object(l["createDecorator"])(function (e, r) {
            (e.props || (e.props = {}))[r] = t;
          })
        );
      }
      ...
      s([f({ default: 0 })], O.prototype, "value", void 0),
        s([f()], O.prototype, "tooltip", void 0),
        s([f()], O.prototype, "dotStyle", void 0),
        s([f()], O.prototype, "tooltipStyle", void 0),
        s(
          [
            f({
              type: String,
        ...
        s([f({ type: Boolean, default: !1 })], O.prototype, "focus", void 0),
        s([f({ default: !1 })], O.prototype, "disabled", void 0),
        (O = s([c.a], O));
      var P = O;
      r("556c");
      function S(t) {
      ...
      s([f({ required: !0 })], C.prototype, "mark", void 0),
        s([f(Boolean)], C.prototype, "hideLabel", void 0),
        s([f()], C.prototype, "stepStyle", void 0),
        s([f()], C.prototype, "stepActiveStyle", void 0),
        s([f()], C.prototype, "labelStyle", void 0),
        s([f()], C.prototype, "labelActiveStyle", void 0),
        (C = s([c.a], C));
      var L,
        N = C,
        B = function (t) {
                  ...
                  return (
                    this.dotsPos.forEach(function (n, o) {
                      if (o !== e) {
                        ...
                        a ||
                          (t =
                            Math.min(Math.abs(s - n), Math.abs(t)) *
                            (t < 0 ? -1 : 1));
                      }
                    }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (var t = [], e = 0; e <= this.total; e++)
                    t.push(
                      new G(e).multiply(this.interval).plus(this.min).toNumber()
                    );
                  return t;
                },
              },
      ...
      var Vt = { None: 0, Drag: 2, Focus: 4 },
        ...
        Mt = (function (t) {
          function e() {
            ...
            return (
              Ot(this, e),
              (t = Et(this, Dt(e).apply(this, arguments))),
              (t.states = new dt(Vt)),
              (t.scale = 1),
              (t.focusDotIndex = 0),
              t
          ...
          return (
            ...
            St(e, [
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this;
                  if (!this.useKeyboard || !this.states.has(Vt.Focus))
                    return !1;
                  ...
                  if (n) {
                    ...
                    r
                      ? (this.control.markList.some(function (t, r) {
                          return (
                            t.value === e.control.dotsValue[e.focusDotIndex] &&
                            ((o = n(r)), !0)
                          );
                        }),
                        o < 0
              ...
              },
              {
                ...
                get: function () {
                  return B(
                    (this.isHorizontal ? this.height : this.width) || _t
                  );
                },
              },
              {
                ...
                get: function () {
                  ...
                  return this.control.processArray.map(function (e, r) {
                    ...
                    return {
                      ...
                      style: ht(
                        ((n = {}),
                        bt(n, t.isHorizontal ? "height" : "width", "100%"),
                        bt(n, t.isHorizontal ? "top" : "left", 0),
                        bt(n, t.mainDirection, "".concat(i, "%")),
                        bt(n, l, "".concat(s - i, "%")),
                        bt(
                          n,
                          "transitionProperty",
              ...
              },
              {
                ...
                get: function () {
                  ...
                  return (
                    ...
                    ht(
                      { width: "".concat(n, "px"), height: "".concat(o, "px") },
                      t
                    )
                  );
                },
      ...
      s([d("change", { default: 0 })], Mt.prototype, "value", void 0),
        s([f({ type: Boolean, default: !1 })], Mt.prototype, "silent", void 0),
        s(
          [
            f({
              default: "ltr",
        ...
        s([f({ type: [Number, String] })], Mt.prototype, "width", void 0),
        s([f({ type: [Number, String] })], Mt.prototype, "height", void 0),
        s([f({ default: 14 })], Mt.prototype, "dotSize", void 0),
        s([f({ default: !1 })], Mt.prototype, "contained", void 0),
        s([f({ type: Number, default: 0 })], Mt.prototype, "min", void 0),
        s([f({ type: Number, default: 100 })], Mt.prototype, "max", void 0),
        s([f({ type: Number, default: 1 })], Mt.prototype, "interval", void 0),
        s(
        ...
        s([f(Array)], Mt.prototype, "data", void 0),
        s([f({ type: Boolean, default: !1 })], Mt.prototype, "lazy", void 0),
        s(
          [
            f({
              type: String,
        ...
        s([f(Function)], Mt.prototype, "keydownHook", void 0),
        s(
          [f({ type: Boolean, default: !0 })],
          Mt.prototype,
          "enableCross",
        ...
        s([f({ type: Boolean, default: !1 })], Mt.prototype, "fixed", void 0),
        s([f({ type: Boolean, default: !0 })], Mt.prototype, "order", void 0),
        s([f(Number)], Mt.prototype, "minRange", void 0),
        s([f(Number)], Mt.prototype, "maxRange", void 0),
        s(
        ...
        s([f(Boolean)], Mt.prototype, "included", void 0),
        s([f(Boolean)], Mt.prototype, "adsorb", void 0),
        s([f(Boolean)], Mt.prototype, "hideLabel", void 0),
        s([f()], Mt.prototype, "dotOptions", void 0),
        s([f()], Mt.prototype, "railStyle", void 0),
        s([f()], Mt.prototype, "processStyle", void 0),
        s([f()], Mt.prototype, "dotStyle", void 0),
        s([f()], Mt.prototype, "tooltipStyle", void 0),
        s([f()], Mt.prototype, "stepStyle", void 0),
        s([f()], Mt.prototype, "stepActiveStyle", void 0),
        s([f()], Mt.prototype, "labelStyle", void 0),
        s([f()], Mt.prototype, "labelActiveStyle", void 0),
        s([h("value")], Mt.prototype, "onValueChanged", null),
        (Mt = s(
          [
            c()({
              data: function () {
              ...
              components: { VueSliderDot: P, VueSliderMark: N },
            }),
          ],
          Mt
        ));
